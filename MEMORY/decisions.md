...
- **Three ledgers (Vehicle Cost / Seller Payments / Funding Sources)** — Funding must be its own ledger; RTGS is seller instrument + funding source, not a cost activity. Active Capital = open funding deploys. → ADR-019; migration `0012_three_ledgers`
